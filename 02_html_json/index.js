...
app.get("/", (req, res) => {
  res.write("<h1>This is the header tag in homepage</h1>");
  res.write("<p>This is paragraph tag in homepage</p>");
  res.send();
});
...
// res.send and res.json are simillar but res.json will convert everything into json such as undefined and null but res.send will convert only json and object into json
app.listen(3000, () => {
  console.log("Hello from the port number 300");
});
